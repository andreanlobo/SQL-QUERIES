...
FROM   schoola,
       schoolb,
       schoolc -- using a cross join to get all possible combinations
WHERE
  -- in the where condition do in such a way that no name from a specific column is repeated and neither the student_id
